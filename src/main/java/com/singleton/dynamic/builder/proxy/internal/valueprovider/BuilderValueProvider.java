...
public class BuilderValueProvider
{
    ...
    private static boolean isThisIgnoreNullElements(SanitizeValueType valueType)
    {
        return SanitizeValueType.IGNORE_NULL_ELEMENTS.equals(valueType);
    }

    private static Object getImmutableReturnValue(Method method, Object argument)
    {
        Class<?> parameterType = method.getParameterTypes()[0];
